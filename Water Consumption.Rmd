...
The issue of water consumpition pose a significant challange as Saudi is a water-scarce country^[[World Resources Institute](http://www.wri.org/blog/2013/12/world%E2%80%99s-36-most-water-stressed-countries)].
...
ggplot(df3) +
  ...
  theme_void() +
  geom_text(data=df1, aes(y=y+0.2, label=freq), x=-0.3, 
